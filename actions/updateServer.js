...
var updateServerAction = {
    ...
    description: 'Utilizes install-releasecandidate.ps1 to update an internal server with a revision of RC',
...
var result = ("powershell.exe -ExecutionPolicy unrestricted -Command \" & 'tools\\Install-ReleaseCandidate.ps1' -Server '" + server + "' -Revision '" + rev + "' -Build '" + build + "' -Major '" + major + "' -Minor '" + minor + "'\" " );	
var child = require('child_process').exec("powershell.exe -ExecutionPolicy unrestricted -Command \" & 'tools\\Install-ReleaseCandidate.ps1' -Server '" + server + "' -Revision '" + rev + "' -Build '" + build + "' -Major '" + major + "' -Minor '" + minor + "'\" " );
